Vagrant.configure("2") do |config|
  ...
  config.vm.define "ansible_awx" do |ansible_awx|
    ...
    # ansible_awx.vm.provision "shell", inline: "apt update && apt upgrade -y"
  end
  ips = ["10.100.1.20", "10.100.1.30", "10.100.1.40"]
  (1..3).each do |i|
    config.vm.define "vm#{i}" do |minion|
      minion.vm.box = "generic/debian10"
